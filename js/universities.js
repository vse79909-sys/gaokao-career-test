 ...
 * 基于安徽省新高考（3+1+2）改革后公开录取数据整理
 * 数据仅供参考，实际录取以当年省考试院公布为准
 * 物理类考生约43万，历史类考生约22万
 */
...
const ANHUI_UNIVERSITIES = [
  ...
  // ===== 211 / 双一流 =====
  {
    ...
    tier: '211/双一流',
    type: '理工',
    admission: { wuli: 14000, lishi: null },
  ...
  },
  {
    ...
    tier: '211/双一流',
    type: '综合',
    admission: { wuli: 28000, lishi: 5500 },
  ...
  // ===== 省重点公办本科 =====
  {
    ...
    tier: '省重点',
    type: '医药',
    admission: { wuli: 38000, lishi: null },
  ...
  },
  {
    ...
    tier: '省重点',
    type: '师范',
    admission: { wuli: 52000, lishi: 9000 },
  ...
  },
  {
    ...
    tier: '省重点',
    type: '财经',
    admission: { wuli: 55000, lishi: 13000 },
  ...
  },
  {
    ...
    tier: '省重点',
    type: '理工',
    admission: { wuli: 62000, lishi: null },
  ...
  },
  {
    ...
    tier: '省重点',
    type: '理工',
    admission: { wuli: 75000, lishi: null },
    dimensions: ['practical', 'investigative', 'conventional'],
  ...
  },
  {
    ...
    tier: '省重点',
    type: '农林',
    admission: { wuli: 78000, lishi: 17000 },
  ...
  },
  {
    ...
    tier: '省重点',
    type: '理工',
    admission: { wuli: 82000, lishi: null },
  ...
  },
  {
    ...
    tier: '省重点',
    type: '医药',
    admission: { wuli: 90000, lishi: 22000 },
  ...
  },
  {
    ...
    tier: '省属',
    type: '医药',
    admission: { wuli: 85000, lishi: null },
  ...
  },
  {
    ...
    tier: '省属',
    type: '医药',
    admission: { wuli: 92000, lishi: null },
    dimensions: ['social', 'investigative'],
  ...
  },
  {
    ...
    tier: '省属',
    type: '理工',
    admission: { wuli: 100000, lishi: null },
  ...
  },
  {
    ...
    tier: '省属',
    type: '综合',
    admission: { wuli: 105000, lishi: 20000 },
  ...
  // ===== 其他公办本科 =====
  {
    ...
    tier: '省属',
    type: '师范',
    admission: { wuli: 115000, lishi: 24000 },
  ...
  },
  {
    ...
    tier: '省属',
    type: '师范',
    admission: { wuli: 120000, lishi: 26000 },
  ...
  },
  {
    ...
    tier: '省属',
    type: '师范',
    admission: { wuli: 128000, lishi: 28000 },
  ...
  },
  {
    ...
    tier: '省属',
    type: '理工',
    admission: { wuli: 138000, lishi: null },
  ...
  },
  {
    ...
    tier: '省属',
    type: '综合',
    admission: { wuli: 142000, lishi: 32000 },
  ...
  },
  {
    ...
    tier: '省属',
    type: '综合',
    admission: { wuli: 148000, lishi: 34000 },
  ...
  },
  {
    ...
    tier: '省属',
    type: '综合',
    admission: { wuli: 152000, lishi: 36000 },
  ...
  },
  {
    ...
    tier: '省属',
    type: '综合',
    admission: { wuli: 155000, lishi: 38000 },
  ...
  },
  {
    ...
    tier: '省属',
    type: '师范',
    admission: { wuli: 158000, lishi: 37000 },
    dimensions: ['social', 'conventional'],
  ...
  },
  {
    ...
    tier: '省属',
    type: '综合',
    admission: { wuli: 162000, lishi: 39000 },
  ...
  },
  {
    ...
    tier: '省属',
    type: '综合',
    admission: { wuli: 165000, lishi: 41000 },
  ...
  },
  {
    ...
    tier: '省属',
    type: '财经',
    admission: { wuli: 168000, lishi: 42000 },
  ...
  },
  {
    ...
    tier: '省属',
    type: '综合',
    admission: { wuli: 172000, lishi: 43000 },
    dimensions: ['conventional', 'social'],
  ...
  // ===== 民办本科 =====
  {
    ...
    tier: '民办',
    type: '综合',
    admission: { wuli: 180000, lishi: 46000 },
    dimensions: ['enterprising', 'conventional', 'practical'],
  ...
  },
  {
    ...
    tier: '民办',
    type: '综合',
    admission: { wuli: 183000, lishi: 48000 },
    dimensions: ['enterprising', 'conventional', 'social'],
  ...
  },
  {
    ...
    tier: '民办',
    type: '理工',
    admission: { wuli: 188000, lishi: null },
    dimensions: ['practical', 'conventional'],
  ...
  },
  {
    ...
    tier: '民办',
    type: '理工',
    admission: { wuli: 190000, lishi: null },
